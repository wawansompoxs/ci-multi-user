<?php
    ...
    $data = query("SELECT * FROM pegawai INNER JOIN keluarga ON pegawai.nip=keluarga.nip WHERE keluarga.nik='$nik'");
?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="pendidikan" id="pendidikan" required autocomplete="off">
                        <option value="Belum Sekolah" <?= $data[0]['pendidikan'] == "Belum Sekolah" ? "selected" : null ?>>Belum Sekolah</option>
