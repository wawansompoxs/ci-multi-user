...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/proses_pangkat') ?>?edit">
            ...
            <div class="form-group row">
                <label for="jenis_pangkat" class="col-sm-3 col-form-label">Golongan</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="gapok" id="gapok" value="<?= $data[0]['gapok'] ?>" placeholder="Gaji Pokok" required autocomplete="off">
                </div>
            </div>
